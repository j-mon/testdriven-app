# services/user/projects/test/test_users.py
...
class TestUserService(BaseTestCase):
    ...
    def test_add_user(self):
        ...
        with self.client:
            response = self.client.post(
                ...
                data=json.dumps({
                    'username': 'jeffrey',
                    'email': 'monsalve.jeffrey@gmail.com',
            ...
            self.assertIn('monsalve.jeffrey@gmail.com was added!',
                          data['message'])
            self.assertIn('success', data['status'])
    ...
    def test_single_user_no_id(self):
        """Ensure error is thrown if an id is an not provided."""
        with self.client:
    ...
    def test_all_users(self):
        ...
        add_user('jeffrey', 'monsalve.jeffrey@gmail.com', 'greaterthaneight')
        add_user('fletcher', 'fletcher@notreal.com', 'greaterthaneight2')
        with self.client:
            ...
            self.assertIn('monsalve.jeffrey@gmail.com',
        ...
        with self.client:
            response = self.client.post(
                ...
                data=json.dumps(dict(
                    username='michael',
                    email='michael@reallynotreally.com')),
                content_type='application/json',
            )
            data = json.loads(response.data.decode())
            self.assertEqual(response.status_code, 400)
