...
class TestUserService(BaseTestCase):
    ...
    def test_add_user(self):
        ...
        with self.client:
            ...
            self.assertIn('monsalve.jeffrey@gmail.com was added!', data['message'])
            self.assertIn('success', data['status'])
    ...
    def test_add_user_invalid_json_keys(self):
        ...
        with self.client:
            response = self.client.post(
                '/users',
                data=json.dumps({'email': 'monsalve.jeffrey@gmail.com'}),
                content_type='application/json',
                )
            data = json.loads(response.data.decode())
            self.assertEqual(response.status_code, 400)
    ...
    def test_all_users(self):
        ...
        add_user('jeffrey', 'monsalve.jeffrey@gmail.com')
        ...
        with self.client:
            ...
            self.assertIn(
                'monsalve.jeffrey@gmail.com', data['data']['users'][0]['email'])
